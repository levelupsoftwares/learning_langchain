...
word_retriever = BM25Retriever.from_documents(
    documents=documents,
    k=4
)
...
retriever = EnsembleRetriever(
    retrievers=[word_retriever,semantic_retriever.as_retriever(search_kwargs={'k':4})],
    weights=[0.4,0.6]
)
print(retriever.invoke('How do rooftop systems lower electricity costs?'))